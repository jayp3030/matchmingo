...
const LoginForm = () => {
  ...
  const handleCal = async () => {
    ...
    if (isLogIn == false) {
      await auth_obj.signIn().then(async (e) => {
        console.log(e);
        data_combine = {
          first_name: e.tv.PZ,
          last_name: e.tv.eY,
            ...
            <div className="form_container fcc">
              <div className="form_part1">
                <form id="login_form_ff" className="fcc">
                  ...
                  <p className="loginPageAlert alert" id="loginPageAlert">
                  ...
                  <div className="remember_me_login">
                    ...
                    <div className="re02">
                      <button className="link" onClick={handleForgetPassword}>
